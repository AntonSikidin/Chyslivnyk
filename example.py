...
class Example:
    ...
    def assertEqual(self,line,line2):
        print("Predict:", line2)
        print("Result :", line)

    # --- Тести для get_cardinal (цілі кількісні) ---
    def test_cardinal_basic(self):
        print('--- Тести для get_cardinal (цілі кількісні) ---')
    ...
    def test_cardinal_tens(self):
        print('--- Тести для get_cardinal (десятки) ---')
    ...
    def test_cardinal_hundreds(self):
        print('--- Тести для get_cardinal (сотні) ---')
    ...
    def test_cardinal_thousands(self):
        print('--- Тести для get_cardinal (тисячі) ---')
    ...
    def test_cardinal_millions(self):
        print('--- Тести для get_cardinal (мільйони) ---')
    ...
    def test_cardinal_billions(self):
        print('--- Тести для get_cardinal (мільярди) ---')
    ...
    def test_cardinal_trillions(self):
        print('--- Тести для get_cardinal (трильйони) ---')
    ...
    def test_cardinal_cases(self):
        ...
        print('--- Тести для get_cardinal (Приклади відмінювання) ---')
    ...
    def test_collective_basic(self):
        print('--- Тести для get_collective (збірні кількісні) ---')
    ...
    def test_collective_cases(self):
        print('--- Тести для get_collective (збірні кількісні відмінювання) ---')
    ...
    def test_fractional_basic(self):
        print('--- Тести для get_fractional (дробові) ---')
    ...
    def test_fractional_cases(self):
        print('--- Тести для get_fractional (дробові, відмінювання) ---')
    ...
    def test_decimal_fractional_basic(self):
        print('--- Тести для get_decimal_fractional (десяткові дроби) ---')
    ...
    def test_decimal_fractional_cases(self):
        print('--- Тести для get_decimal_fractional (десяткові дроби/відмінювання) ---')
    ...
    def test_ordinal_basic(self):
        print(' --- Тести для get_ordinal (порядкові) ---')
    ...
    def test_ordinal_cases(self):
        print(' --- Тести для get_ordinal (порядкові/відмінювання) ---')
...
if __name__ == '__main__':
    example = Example()
    example.test_cardinal_basic()
    example.test_cardinal_tens()
    example.test_cardinal_hundreds()
    example.test_cardinal_thousands()
    example.test_cardinal_millions()
    example.test_cardinal_billions()
    example.test_cardinal_trillions()
    example.test_cardinal_cases()
    example.test_collective_basic()
    example.test_collective_cases()
    example.test_fractional_basic()
    example.test_fractional_cases()
    example.test_decimal_fractional_basic()
    example.test_decimal_fractional_cases()
    example.test_ordinal_basic()
    example.test_ordinal_cases()